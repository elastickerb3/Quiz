...
function FragenAntwortenUndCo(){
    if(level == 1){
        ChangeQuiz("Das schnellste Landtier der Erde, der Gepard, kommt auf",
                    "80 km h.",
                    "90 kmh.",
                    "110 km h.",
                    "c"
...
if(level -1 == 68){
    ChangeQuiz("Die längste künstliche Wasserstraße aller Zeiten war",
                "95 km lang.",
                "193 km lang.",
                "1800 km lang.",
                "c"
